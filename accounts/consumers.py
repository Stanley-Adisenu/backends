...
class ChatConsumer(AsyncWebsocketConsumer):
    async def connect(self):
        from accounts.models import Room  # Import models here to avoid early import
    ...
    async def receive(self, text_data):
        from accounts.models import Room, Message  # Import models here
        from accounts.serializers import MessageSerializer  # Import serializers here
    ...
    @sync_to_async
    def serialize_message(self, message):
        from accounts.serializers import MessageSerializer  # Import here to ensure models are ready
        return MessageSerializer(message).data
